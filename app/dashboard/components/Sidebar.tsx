import { BarChart2, Box, Briefcase, CirclePercent, FileText, HandPlatter, Layers, LayoutDashboard, NotepadText, Package, PieChart, ReceiptText, ShoppingCart, ShoppingCartIcon, Tag } from 'lucide-react'
